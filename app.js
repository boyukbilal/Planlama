...
function paymentStatus(day){
  const today=new Date().getDate();
  if(today>day) return "Kontrol et";
  if(day-today<=3) return "Yaklaşıyor";
  return "Bekliyor";
}
function exportCSV(){
  ...
  const a=document.createElement("a"); a.href=URL.createObjectURL(blob); a.download="bilal-finance-kayitlar.csv"; a.click();
}
